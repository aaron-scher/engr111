...
| 3 | **Chapter 1**, Keys to Success in Engineering Study. 1.2 (what is success, goal setting) and 1.3 (effort, approach, attitude) are the core · **Felder, *An Engineering Student Survival Guide*** ([PDF](https://engr.ncsu.edu/wp-content/uploads/drive/1L5s3YvmPtcJcMkA8OeNdzh-qWxEPDT-2/1993-survivalguide.pdf), also in Moodle) |
...
- **The second key to success** is "Approach: work smart" on p.7 and "Approach: work efficiently" on p.19. Same edition, two wordings.
