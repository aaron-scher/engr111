---
title: "ENGR-111: Introduction to Engineering"
layout: default
---
...
- [Measure and Plot Assignment 1](homework-measure-convert-plot.html)

## In-class work

- [In-Class Work 1: Who Built This?](class-work-who-built-this.html)
- [In-Class Work 2: From a Vague Wish to a Real Specification](class-work-vague-wish-to-specification.html)
- [In-Class Work 3: Decision Matrix](class-work-decision-matrix.html)
- [In-Class Work 4: Job Functions](class-work-job-functions.html)
- [In-Class Work 5: A Common Basis](class-work-common-basis.html)
...
- Samples from previous students: a [proposal](files/sample-proposal.pdf), a [final report](files/sample-final-report.pdf), and two final papers ([1](files/sample-final-paper-1.pdf), [2](files/sample-final-paper-2.pdf))
